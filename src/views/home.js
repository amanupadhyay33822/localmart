        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Connecting you with your favorite local shops</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover how our platform can enhance your shopping
                      experience
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Easily browse through various shops listed on the website"
              ></FeatureCard>
              <FeatureCard
                heading="Contact Shopkeepers"
                subHeading="Customers can directly contact shopkeepers to inquire about products"
              ></FeatureCard>
              <FeatureCard
                heading="Business Growth"
                subHeading="Shopkeepers can expand their business by listing their shops on the website"
              ></FeatureCard>
              <FeatureCard
                heading="Convenient Shopping"
                subHeading="Enjoy convenient shopping by exploring multiple shops in one place"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>Select the perfect plan to boost your business</span>
              </span>
            </span>
          </div>
          <div className="home-container05">
            ...
            <div className="basicPricingCard home-pricing-card1">
              <div className="home-container11">
                ...
                <span className="bodySmall">
                  Upgrade to our Basic plan for more benefits
                </span>
              </div>
              ...
              <div className="home-container13">
                ...
                <div className="home-container15">
                  ...
                  <span className="bodySmall">Highlighted shop listing</span>
                </div>
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">Access to analytics</span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container20">
                ...
                <div className="home-container22">
                  ...
                  <span className="bodySmall">Featured shop placement</span>
                </div>
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">Promotion on social media</span>
                </div>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Discover a variety of shops in your area offering unique
                  products and services. Help your community thrive by shopping
                  locally. Join us in supporting local businesses!
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container27">
              <Question1
                answer="You can list your shop on our website by creating an account and filling out the necessary information about your shop."
                question="How can I list my shop on the website?"
              ></Question1>
              <Question1
                answer="Listing your shop on our website is currently free of charge."
                question="Is there a fee for listing my shop on the website?"
              ></Question1>
              <Question1
                answer="Customers can contact a shop listed on the website by using the contact information provided on the shop's profile page."
                question="How can customers contact a shop listed on the website?"
              ></Question1>
              <Question1
                answer="Customers cannot purchase items directly from the website. They need to contact the shop directly to make a purchase."
                question="Can customers purchase items directly from the website?"
              ></Question1>
              <Question1
                answer="You can update information about your shop on the website by logging into your account and editing your shop's profile."
                question="How can I update information about my shop on the website?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container28">
            ...
            <nav className="home-nav1">
              <span className="bodySmall">Home</span>
              <span className="home-nav222 bodySmall">Shops</span>
              <span className="home-nav322 bodySmall">Contact</span>
              <span className="home-nav422 bodySmall">Sign Up</span>
